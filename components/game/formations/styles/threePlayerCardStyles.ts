...
export const threePlayerCardStyles = StyleSheet.create({
  // Player Zone Content - Scaled for 3 players
  playerContent: {
    alignItems: 'center',
  ...
  // Player Name - Scaled for 3 players
  playerName: {
  ...
  // Life Display - Scaled for 3 players
  lifeContainer: {
    alignItems: 'center',
  ...
  // Heart Icon - Scaled for 3 players
  heartIcon: {
  ...
  // Life Controls - Horizontal layout for 3 players
  lifeControls: {
    flexDirection: 'row',
    justifyContent: 'center',
    alignItems: 'center',
